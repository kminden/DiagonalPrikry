...
Examples of subcomplete forcing include all countably closed forcing, Prikry forcing, and Namba forcing (under $\CH$), as shown by Jensen~\cite[Section 3.3]{Jensen:2014}. Clearly subcomplete forcing notions differ from proper forcing notions, as proper forcing notions all satisfy a countable covering property and thus cannot change cofinalities to $\omega$. Like countably closed forcing, no subcomplete forcing can add new reals, and indeed, $ccc$ forcing notions are not subcomplete \cite{Minden:2017fr}.
