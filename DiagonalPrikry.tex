...
\begin{figure}[h!] \label{figure:N} \caption{Diagram depicting $\sigma$.}
\begin{tikzpicture}
\draw (-1,0)--(-1,3);
\node [below] at (-1,0) {$\N$};
\node at (-1,2.95) {$\frown$};
...
\begin{definition}[$\mathcal T$] For an admissible structure $M$ with $S, \overline S, \sigma, \N, N, \theta, \D, \U, c \in M$ we define the $\in$-theory $\mathcal T(M)$ as follows.
\begin{description}
	\item[predicate] $\in$.
...
\begin{figure}[h!] \label{figure:N0N} \caption{Diagram depicting the liftup $\langle N_0, \sigma_0\rangle$.}
\begin{tikzpicture}
\draw (-3,0)--(-3,3);
\node [below] at (-3,0) {$\N$};
\node at (-3,2.95) {$\frown$};
...
\begin{definition}[$\mathcal L$] Let $\langle N_*, \sigma_* \rangle$ be a transitive liftup of $\N$ along with some reasonable restriction of $\sigma$, ie. the liftup of $\langle \N, \sigma \rest H_{\alpha}^{\N} \rangle$, where $\alpha \geq \overline \kappa(0)$ is regular in $\N$, and say $\sigma_*(\overline \theta, \overline{\D}, \overline{\U}, \overline c) = \theta_*, \D_*, \U_*, c_*.$ 
...
\begin{figure}[h!] \label{figure:N1N0N} \caption{Diagram depicting the liftups $\langle N_0, \sigma_0\rangle$ and $\langle N_1, \sigma_1\rangle$.}
\begin{tikzpicture}
\draw (-3,0)--(-3,3);
