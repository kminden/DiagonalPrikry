...
%The upper parts are now defined for each $\kappa\in D$, and the extension relation is defined in the same way, where a condition is strengthened by end-extending the stems on each coordinate, as well as the whole sequence of stems, and shrinking the upper parts.
