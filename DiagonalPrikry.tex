...
Indeed, suppose otherwise, that there is one unique such embedding. Then $\N$ may be defined pointwise, by elementarity of the unique map, and since $\N$ is countable. This contradicts the previous lemma.
