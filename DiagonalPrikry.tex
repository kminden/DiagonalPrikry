...
%%%%%%K I would say yes, by regularity
...
In particular, $\nu_0$ is the critical point of the embedding $k_0$. We illustrate the situation up to this point with the following diagram. 
...
\begin{claimno} $\mathcal L_0=\mathcal L(L_{\delta_{N_0}}(N_0))$ is consistent. \end{claimno}
...
Below is a picture of all of the relevant transitive liftups.
\begin{center}
\begin{tikzpicture}
\draw (-3,0)--(-3,3);
